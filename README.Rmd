...
1. `rastafriwpop2020`   raster grid, population density 2020 from WorldPop aggregated to 20km squares
1. `rastafriwpop2000`   raster grid, population density 2000 from WorldPop aggregated to 20km squares
...
Population density data are from WorldPop clipped to Africa and aggregated to 20km resolution to make them more manageable. WorldPop datasets are licensed under [Creative Commons Attribution 4.0 International] (https://creativecommons.org/licenses/by/4.0/).
