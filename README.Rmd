...
The motivation is to provide analysts based in Africa with example datasets that they can more easily relate to, rather than needing to use ones from the North.
...
1. `africapitals`     points, 50 capital cities
